...
export function extractFromHtml(html) {
  ...
  // Si la nouvelle méthode a trouvé les vues, on suppose qu'elle a tout trouvé
  if (counts.views > 0) {
      // On complète avec les fallbacks meta pour être sûr
  ...
  if (old_stats?.views > 0) {
      console.log("Extraction réussie avec la méthode brute-force.");
